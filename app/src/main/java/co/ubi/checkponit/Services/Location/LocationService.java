package co.ubi.checkponit.Services.Location;
...
public class LocationService extends IntentService implements GoogleApiClient.ConnectionCallbacks,
    ...
    public static int UPDATE_INTERVAL_IN_SECONDS = 20;
    // Update frequency in milliseconds
    private static final long UPDATE_INTERVAL = MILLISECONDS_PER_SECOND
            * UPDATE_INTERVAL_IN_SECONDS;
    // The fastest update frequency, in seconds
    private static int FASTEST_INTERVAL_IN_SECONDS = 10;
    // A fast frequency ceiling in milliseconds
    private static final long FASTEST_INTERVAL = MILLISECONDS_PER_SECOND
            * FASTEST_INTERVAL_IN_SECONDS;
    public static Location serviceLocation;
    public static boolean isServeiceRunning = false;

    public static Location getServiceLocation() {
