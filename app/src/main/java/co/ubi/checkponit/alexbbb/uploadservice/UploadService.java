package co.ubi.checkponit.alexbbb.uploadservice;
...
public class UploadService extends IntentService {
    ...
    public static String NAMESPACE = "co.ubi.checkponit";
    ...
    private void handleFileUpload(final String uploadId, final String url, final String method,
        ...
        try {
            ...
            if (serverResponseCode == 200) {
              ...
              //  br.close();
                Log.e("response photo", sb.toString());
                broadcastCompleted(uploadId, serverResponseCode, sb.toString());
            } else {
                final String serverResponseMessage = conn.getResponseMessage();
                //  Log.e(TAG, "conn ::::::: " + conn.getOutputStream().toString());
                // Log.e(TAG, "conn ::::::: ResponseMessage" + conn.getResponseMessage());
