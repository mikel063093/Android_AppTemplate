 ...
 */
package co.ubi.checkponit.sothree.slidinguppanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * No-op stubs for {@link co.ubi.checkponit.sothree.slidinguppanel.SlidingUpPanelLayout.PanelSlideListener}. If you only want to implement a subset
