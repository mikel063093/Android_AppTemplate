package co.ubi.checkponit.UI.CustomView;
...
public class FloatingActionButton extends View {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.FloatingActionButton_);
        mColor = a.getColor(R.styleable.FloatingActionButton__colr, Color.WHITE);
        mButtonPaint.setStyle(Paint.Style.FILL);
        mButtonPaint.setColor(mColor);
        float radius, dx, dy;
        radius = a.getFloat(R.styleable.FloatingActionButton__shadowRadius, 10.0f);
        dx = a.getFloat(R.styleable.FloatingActionButton__shadowDx, 0.0f);
        dy = a.getFloat(R.styleable.FloatingActionButton__shadowDy, 3.5f);
        int color = a.getInteger(R.styleable.FloatingActionButton__shadowColor, Color.argb(100, 0, 0, 0));
        mButtonPaint.setShadowLayer(radius, dx, dy, color);

        Drawable drawable = a.getDrawable(R.styleable.FloatingActionButton__drawable);
        if (null != drawable) {
